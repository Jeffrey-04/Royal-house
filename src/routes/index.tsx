...
const IMG = {
  ...
  gallery: [
    `${U}1476224203421-74177700de7a?auto=format&fit=crop&w=800&h=500&q=80`,
    `${U}1567620905732-2d1ec7ab7445?auto=format&fit=crop&w=400&h=500&q=80`,
    `${U}1546069901-ba9599a7e63c?auto=format&fit=crop&w=400&h=240&q=80`,
    `${U}1565557623263-b2c0cf45eb5b?auto=format&fit=crop&w=400&h=240&q=80`,
  ],
